...
*/
//GET may be marked in the future
...
$f3->route('POST /signup',
	function($f3){
		...
		if($result){
			...
			$f3->set('return_page1','signup');
			$f3->set('return_page2','welcome');
			$f3->set('text1','return to signup page');
			$f3->set('text2','return to welcome page');
		}else{
			$f3->set('result','success');
			$f3->set('return_page1','welcome');
			$f3->set('return_page2',NULL);
			$f3->set('text1','return to welcome page');
			$f3->set('text2','');
		}
